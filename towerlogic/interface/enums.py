...
class UIField(StrEnum):
    ...
    BS_INSTANCE_NAME = "bs_instance_name"
    POLICY_TOGGLE = "policy_toggle"
    POLICY_EPSILON = "policy_epsilon"
    POLICY_MODEL_PATH = "policy_model_path"
    POLICY_TRAIN_TOGGLE = "policy_train_toggle"
    POLICY_LR = "policy_lr"
    POLICY_FREE_PLACEMENT = "policy_free_placement"
    POLICY_MIN_ELIXIR = "policy_min_elixir"
    POLICY_ALLOW_HOLD = "policy_allow_hold"
    POLICY_DEBUG_DETECTION = "policy_debug_detection"
    POLICY_DEBUG_OVERLAY = "policy_debug_overlay"
    POLICY_DEBUG_HP_LOG = "policy_debug_hp_log"
    POLICY_DEBUG_HAND_CONF = "policy_debug_hand_conf"
    POLICY_STRICT_ELIXIR = "policy_strict_elixir"
    POLICY_SPELL_GATE = "policy_spell_gate"
