...
from towerlogic.utils.platform import is_windows

if TYPE_CHECKING:
    from towerlogic.emulators.base import BaseEmulatorController
...
def get_emulator_registry() -> dict[EmulatorType, type["BaseEmulatorController"]]:
    ...
    if is_windows():
        from towerlogic.emulators.google_play import GooglePlayEmulatorController
